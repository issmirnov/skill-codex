...
## Running a Task
1. Ask the user (via `AskUserQuestion`) which model to run (`gpt-5.5gpt-5.4gpt-5.4-minigpt-5.3-codexgpt-5.2`) AND which reasoning effort to use (`xhigh`, `high`, `medium`, or `low`) in a **single prompt with two questions**.
